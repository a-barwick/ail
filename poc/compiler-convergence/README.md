...
| `release-review` | a remote nominal-type mismatch and hidden ambient authority across 35 modules; no `architecture.json` | the blind arm in all 7 trials, 1 retry against 2 | [RESULTS-release-review.md](RESULTS-release-review.md), [fixture-release-review/README.md](fixture-release-review/README.md) |
